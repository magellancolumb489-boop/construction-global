...
-- Buckets stay public-readable so product / auction detail pages can render
...
-- ============================================================================
-- 1) Ensure the two public buckets exist with sensible limits.
-- ============================================================================
insert into storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
values
  ('listing-images', 'listing-images', true, 10 * 1024 * 1024, array['image/jpeg', 'image/png', 'image/webp', 'image/avif']),
  ('auction-images', 'auction-images', true, 10 * 1024 * 1024, array['image/jpeg', 'image/png', 'image/webp', 'image/avif'])
...
-- ============================================================================
-- 4) auction-images: public read, owner-folder writes
-- ============================================================================
...
create policy "auction-images owner insert"
on storage.objects for insert
to authenticated
with check (
...
create policy "auction-images owner update"
on storage.objects for update
to authenticated
using (
  bucket_id = 'auction-images'
...
create policy "auction-images owner delete"
on storage.objects for delete
to authenticated
using (
  bucket_id = 'auction-images'
